...
sed -i -e 's@.*qt_sbom/SPDXRef-PackagedFile-qt-plugin-MockExtensionPlugin.cmake")@@' \
...
* Tue Feb 04 2025 Jan Grulich <jgrulich@redhat.com> - 6.8.1-4
- Drop runtime dependency on qt6-qtbase-private-devel
  Resolves: RHEL-77748
